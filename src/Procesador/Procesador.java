...
public class Procesador extends javax.swing.JFrame {
    ...
    public Procesador() {
        ...
        ejecutando1.setVisible(false);
        ejecutando2.setVisible(false);
        ejecutando3.setVisible(false);
        Cliente_esperando = 0;
        n1.numbarb = 0;
        n2.numbarb = 1;
        n3.numbarb = 2;
    ...
    private void initComponents() {
        ...
        nucleo1 = new javax.swing.JLabel();
        nucleo2 = new javax.swing.JLabel();
        nucleo3 = new javax.swing.JLabel();
        ...
        ejecutando1 = new javax.swing.JLabel();
        ejecutando2 = new javax.swing.JLabel();
        ejecutando3 = new javax.swing.JLabel();
        ...
        nucleo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ProcesoInctivo.png"))); // NOI18N
        jPanel1.add(nucleo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        nucleo2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ProcesoInctivo.png"))); // NOI18N
        jPanel1.add(nucleo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1, -1));

        nucleo3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ProcesoInctivo.png"))); // NOI18N
        jPanel1.add(nucleo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, -1, -1));
        ...
        ejecutando1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ProcesoActivo.png"))); // NOI18N
        getContentPane().add(ejecutando1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 440, -1, -1));

        ejecutando2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ProcesoActivo.png"))); // NOI18N
        getContentPane().add(ejecutando2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 440, -1, -1));

        ejecutando3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ProcesoActivo.png"))); // NOI18N
        getContentPane().add(ejecutando3, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 440, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        nuevos = new Ingresar();
        nuevos.nextProceso = nextProceso++;
        nuevos.start();
    ...
    Ingresar nuevos;
    private static Proceso Ranuras[] = new Proceso[3]; // Número de ranuras en el búfer

    public void quitar_elemento(int pos) {

        if (list_espera != null) {
            Ranuras[pos] = list_espera;
    ...
    public class Ingresar extends Thread {
        ...
        public int nextProceso;

        @Override
        public void run() {

            Proceso nuevo = new Proceso("C" + this.nextProceso);
    ...
    public class Nucleo extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (Ranuras[numbarb] != null) {
                    this.info.setText("Activando");
                    this.despertar(numbarb);
                    Proceso elemento = Ranuras[numbarb];
                    try {
                        mutex.acquire(); // Entra a la región crítica
                    } catch (InterruptedException ex) {
                        Logger.getLogger(Procesador.class.getName()).log(Level.SEVERE, null, ex);
        ...
        public void despertar(int i) {
            switch (i) {
                case 0:
                    nucleo1.setVisible(false);
                    lbl_zz1.setVisible(false);
                    ejecutando1.setVisible(true);
                    break;
                case 1:
                    nucleo2.setVisible(false);
                    lbl_zz2.setVisible(false);
                    ejecutando2.setVisible(true);
                    break;
                case 2:
                    nucleo3.setVisible(false);
                    lbl_zz3.setVisible(false);
                    ejecutando3.setVisible(true);
                    break;
            }
        }
        ...
        public void dormir(int i) {
            switch (i) {
                case 0:
                    nucleo1.setVisible(true);
                    lbl_zz1.setVisible(true);
                    ejecutando1.setVisible(false);
                    break;
                case 1:
                    nucleo2.setVisible(true);
                    lbl_zz2.setVisible(true);
                    ejecutando2.setVisible(false);
                    break;
                case 2:
                    nucleo3.setVisible(true);
    ...
    private javax.swing.JLabel ejecutando1;
    private javax.swing.JLabel ejecutando2;
    private javax.swing.JLabel ejecutando3;
    ...
    private javax.swing.JLabel nucleo1;
    private javax.swing.JLabel nucleo2;
    private javax.swing.JLabel nucleo3;
